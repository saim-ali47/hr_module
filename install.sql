...
@@application/shared_components/user_interface/lovs/degree_lov.sql
@@application/shared_components/user_interface/lovs/department_department_name.sql
@@application/shared_components/user_interface/lovs/designation_designation_name.sql
@@application/shared_components/user_interface/lovs/district_lov.sql
@@application/shared_components/user_interface/lovs/employee_id_lov.sql
@@application/shared_components/user_interface/lovs/employee_name.sql
@@application/pages/page_groups.sql
@@application/shared_components/navigation/breadcrumbs/breadcrumb.sql
@@application/shared_components/navigation/breadcrumbs/salary.sql
